    ...
    export default {
        ...
        computed: {
            ...
            staredClasses: function () {
                return {
                    fas: this.project.user_actions.starred,
                    far: !this.project.user_actions.starred,
                    'fa-star': true
                }
            },
            watchingClasses() {
                return {
                    'fas': true,
                    'fa-eye-slash': this.project.user_actions.watching,
                    'fa-eye': !this.project.user_actions.watching,
                }
            },
            isMember: function () {
